...
public class BlockRegistry {
	public static void register()
	{
		...
		BlocksRegistry.registerBlock(chests[0], "ironChest", TerraArts.class, null);
		BlocksRegistry.registerBlock(chests[1], "goldChest", TerraArts.class, null);
		BlocksRegistry.registerBlock(chests[2], "diamondChest", TerraArts.class, null);
		BlocksRegistry.registerBlock(chests[3], "gemChest", TerraArts.class, null);
		BlocksRegistry.registerBlock(chests[4], "darknessChest", TerraArts.class, null);
	}
