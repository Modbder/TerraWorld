...
public class ContainerCombinery extends Container{
	 private IInventory inv;
	    public ContainerCombinery(InventoryPlayer par1InventoryPlayer, TileEntity par2)
	    {
	        this.inv = (IInventory) par2;
	        int i;
	        this.addSlotToContainer(new Slot((IInventory) par2, 0, 26, 23));
	        this.addSlotToContainer(new Slot((IInventory) par2, 1, 136, 23));
	        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, (IInventory) par2, 2, 81, 23));
	        for (i = 0; i < 3; ++i)
	        {
	            for (int j = 0; j < 9; ++j)
	            {
